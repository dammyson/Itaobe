          ...
          <View>
            ...
            <Item regular style={{ marginTop: 7 }}>
              ...
              <Picker
                ...
                onValueChange={(size) => this.getStateList(size)}
              >
            ...
            <Item regular style={{ marginTop: 7 }}>
              ...
              >
                 <Picker.Item label="Select a state" value="key0" />
                {this.renderState()}
              </Picker>
            ...
            <Item regular style={{ marginTop: 7 }}>
              <Text style={{ paddingLeft: 5, marginLeft: 0 }}>*</Text>
              <Input placeholder='Postcode' maxLength={6} keyboardType='numeric' onChangeText={(text) => this.setState({ postcode: text })} placeholderTextColor="#687373" />
            </Item>
